...
public class JSONToXLSX {
    ...
    public static void convert(String jsonInput, String filename, String dataArrayKey, String sheetName) {
    ...
    @SneakyThrows(IOException.class)
    private static ArrayNode extractDataArrayFromJson(String jsonInput, String dataArrayKey) {
    ...
    @SneakyThrows(IOException.class)
    private static void writeFile(Workbook workbook, String filePath){
